function Player(container, option) {
    ...
    hikPlayerHtml = '<object classid="clsid:872B31BA-01B5-4264-93E0-169d9C298C06" style="width: 100%; height: 100%; z-index: -1"></object>';
    ezuPlayerHtml = '<object classid="clsid:54FC7795-1014-4BF6-8BA3-500C61EC1A05" style="width: 100%; height: 100%; z-index: -1"></object>';
    if(!option.type || option.type === 0) { // ezuPlayer
    ...
    } else if(option.type === 1) { // hikPlayer
...
Player.prototype.getPlayer = function() {
    if(this.type === 1) { // hikPlayer
        return this.hikPlayer;
    } else if(this.type === 0) { // ezuPlayer
        return this.ezuPlayer;
    }
}
